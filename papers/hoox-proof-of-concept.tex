...
\author{
  ...
  \texttt{https://github.com/hoox-sh/hoox}
}
...
\textsc{HOOX} consists of a multi-Worker edge mesh (ten core production Workers plus optional Pine tooling) plus supporting Durable Objects and bindings. The signal lifecycle is divided into seven explicit stages: ingress, validation \& authentication, idempotency \& deduplication (Durable Object), risk \& position management, routing \& exchange adaptation, execution \& confirmation, and observability/reporting/analytics.
...
\url{https://github.com/hoox-sh/hoox}
