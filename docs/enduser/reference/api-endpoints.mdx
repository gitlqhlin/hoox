...
Full setup: [Test Trading](/docs/enduser/guides/test-trading).
...
- [**Request Payload Schemas**](/docs/enduser/reference/payloads) — Analyze the complete JSON request schemas and TypeScript interfaces.
- [**CLI Commands Reference**](/docs/enduser/reference/cli-commands) — Review all CLI commands, options, and JSON flags.
