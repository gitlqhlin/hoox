...
<Tip>
  ...
  the agent-worker. See the [agent-worker profile](/docs/devops/workers/agent-worker).
</Tip>

### 🔗 Next Steps

- **[Zero Trust & Secret Security](/docs/enduser/guides/secrets-security)** — Lock down your AI endpoints and exchange API keys.
- **[TUI Operations Cockpit](/docs/enduser/guides/tui)** — View live position drawdowns and trailing stops visually in your terminal.
