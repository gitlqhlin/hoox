...
- [**Monitoring Operations Guide**](/docs/enduser/guides/monitor-trading) — Audit system status, tail console logs, and verify fills.
- [**CLI Reference Manual**](/docs/enduser/reference/cli-commands) — Review all CLI commands, options, and JSON flags.
- [**Configuration Dictionary**](/docs/enduser/reference/configuration) — Map all 31 environment variables and 16 KV manifest entries.
