...
For tunnel vs Access decision tables, probe expectations, and `hoox tunnel check`, see [Private ingress](/docs/devops/deployment/private-ingress).
...
- **[Next.js Dashboard worker Profile](/docs/devops/workers/dashboard)** — Review OpenNext compilation and asset bindings.
- **[System Observability & Metrics](/docs/devops/deployment/monitoring)** — Setup time-series logging and Analytics Engine tables.
