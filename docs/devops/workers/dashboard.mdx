...
<Frame caption="Setup wizard with Cloudflare infrastructure map">
  <img src="/docs/images/dashboard/setup.png" alt="Dashboard setup wizard welcome and infrastructure" />
</Frame>

<Frame caption="Navigating primary dashboard pages">
  <img src="/docs/images/gifs/dashboard-nav.gif" alt="GIF of dashboard sidebar navigation" />
</Frame>

Page-by-page stills: [Interface gallery](/docs/enduser/guides/screenshots#dashboard).
...
- [**agent-worker Profile**](/docs/devops/workers/agent-worker) — Review AI chat streaming and risk evaluation structures.
- [**d1-worker Profile**](/docs/devops/workers/d1-worker) — Check REST schemas that feed database metrics to the dashboard.
