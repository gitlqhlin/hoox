...
- **[Core Installation](/docs/enduser/getting-started/installation)** — Provision prerequisites (Bun runtime, Cloudflare credentials) and bootstrap a project.
...
- **[Idempotency & Durable Objects](/docs/enduser/concepts/idempotency)** — Preventing catastrophic double-execution and race conditions during high-frequency events.
...
- **[Terminal UI Operations](/docs/enduser/guides/tui)** — Launch and navigate the full-screen 9-view operations cockpit (`./hoox-tui`).
- **[Edge Database Operations](/docs/enduser/guides/database-ops)** — Manage global SQLite schemas, track drizzle migrations, and run D1 queries.
...
- **[TradingView Webhook Integration](/docs/enduser/tutorials/tradingview-webhook)** — Write customized Pine Script v5 indicators that ping the Hoox webhook receiver.
...
- **[Email Signal Routing](/docs/enduser/tutorials/email-signals)** — Configure email parsing services to convert raw inbox alerts into edge trade executions.
...
- **[Configuration Properties](/docs/enduser/getting-started/configuration)** — Comprehensive dictionary of all 31 env keys and 16 KV key-value items.
