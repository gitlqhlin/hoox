...
<Tip>
  Need to tail live worker logs to debug a custom strategy? Run `hoox logs worker
...
- **[Debugging Runbook](/docs/devops/development/debugging)** — Diagnose local and remote V8 exceptions using diagnostic profiles.
- **[Self-Healing & Repair](/docs/enduser/guides/repair)** — Recover from degraded workers and provision missing bindings.
