...
```mermaid
graph TD
    UT["📦 Unit Tests<br/>(~4,600 tests)"] -->|Next Layer| IT["🔗 Integration Tests<br/>(~12 tests)"]
    IT -->|Next Layer| ST["🛡️ Security Tests<br/>(~40 tests)"]
    ST -->|Next Layer| E2E["🚀 E2E Smoke Tests<br/>(~57 tests)"]
