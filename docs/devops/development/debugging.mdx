...
- **[Testing Framework & QA Standards](/docs/devops/development/testing)** — Run local unit and integration tests using Bun's native test runner.
- **[Self-Healing & System Repair](/docs/enduser/guides/repair)** — Run diagnostics, targeted component repairs, and full system rebuilds.
