...
- **[CLI features](/docs/devops/cli-features)** (0.13.x: mesh hardening notes, monorepo remember, secrets modes, Linear Rail, setup gates) · **[TUI](/docs/devops/tui)** · **[Pattern consolidation](/docs/devops/refactoring/workers-pattern-consolidation)** · **[Security](/docs/devops/security/overview)**
