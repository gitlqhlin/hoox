...
- **Post-hardening gateway checklist**: [`workers/hoox-worker/DEPLOY.md`](https://github.com/hoox-sh/hoox/blob/main/workers/hoox-worker/DEPLOY.md)
...
- **[CI/CD Pipelines Reference](/docs/devops/deployment/cicd)** — Automate edge deployments using GitHub Actions.
- **[Observability & Time-Series Monitoring](/docs/devops/deployment/monitoring)** — Stream console logs and check analytics datasets.
