...
| **Dashboard shows 500**       | Next.js build failed or D1 schema mismatch.       | Re-run `hoox deploy dashboard` and check logs: `hoox logs worker dashboard`.                                                        |
...
- [**Real-Time Observability & Monitoring**](/docs/enduser/guides/monitor-trading) — Audit live fills, tail console logs, and run health diagnostics.
- [**System Self-Healing & Repair**](/docs/enduser/guides/repair) — Rebuild broken bindings and recover from deployment anomalies.
- [**Infrastructure Management**](/docs/enduser/guides/manage-infra) — Provision and inspect KV, Queues, R2, and Vectorize indexes.
