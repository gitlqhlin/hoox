...
| `trade-worker`       | CEX execution (Binance / Bybit / MEXC) + DEX spots (Uniswap V3 / Jupiter) via wallet binding                                                                                                | [trade-worker](https://github.com/hoox-sh/trade-worker)             |
...
| `web3-wallet-worker` | On-chain signing — Uniswap V3 (Ethereum/Arbitrum), Jupiter Swap V2 (Solana)                                                                                                                 | [web3-wallet-worker](https://github.com/hoox-sh/web3-wallet-worker) |
...
| **trade-worker**       | CEX + DEX spots (Uniswap V3 / Jupiter)                   | [hoox-sh/trade-worker](https://github.com/hoox-sh/trade-worker)             |
...
| **web3-wallet-worker** | Uniswap V3 + Jupiter Swap V2 signing                     | [hoox-sh/web3-wallet-worker](https://github.com/hoox-sh/web3-wallet-worker) |
