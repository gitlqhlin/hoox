...
Sandbox fills use position ids like `bybit-testnet-BTCUSDT-LONG`. Filter them in the Dashboard Positions **mode** control (Live only / Testnet / Live + Test). See [Test Trading](/docs/enduser/guides/test-trading).
...
<Tip>
  ...
  Guide**](/docs/enduser/guides/repair) to run automated diagnostics and restore service bindings!
</Tip>

### 🔗 Next Steps

- [**Self-Healing & Repair**](/docs/enduser/guides/repair) — Diagnose connection drops, recreate broken bindings, and rebuild environments.
- [**Terminal UI Operations**](/docs/enduser/guides/tui) — Monitor health status, tail logs, and edit configurations interactively in a full-screen GUI cockpit.
- [**Infrastructure Management**](/docs/enduser/guides/manage-infra) — Manage KV config namespaces, Queue parameters, and R2 storage buckets.
