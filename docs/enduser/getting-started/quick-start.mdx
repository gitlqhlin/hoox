...
description: "Install the CLI, run hoox onboard, deploy the edge mesh, and fire a simulated trade webhook in under 5 minutes."
---
...
Run the one-shot bootstrap from the monorepo root (or after the CLI has remembered
that path — see [Installation → Run from any directory](/docs/enduser/getting-started/installation#run-from-any-directory-monorepo-remember)):
...
<ol>
  <li>
    <strong>D1 Edge Database</strong> (<code>hoox-db</code> / trade-data-db)
  </li>
  <li>
...
See **[Test Trading](/docs/enduser/guides/test-trading)** for credential setup, D1 isolation, and dashboard filters.
...
- [**How Hoox Works**](/docs/enduser/concepts/how-hoox-works) — Take a deep dive into the edge processing pipelines.
- [**Terminal UI Guide**](/docs/enduser/guides/tui) — Run, hot-reload, and inspect live metrics in a full-screen console interface.
- [**Set Up Telegram Alerts**](/docs/enduser/tutorials/telegram-bot) — Link your bot to get order fills pushed straight to your phone.
