...
- **[Data Flow Mapping](/docs/devops/architecture/data-flow)** — Step-by-step sequence charts of trade executions, backups, and metrics.
- **[Bindings Catalog](/docs/devops/architecture/bindings)** — Review complete environment namespaces and bound objects.
