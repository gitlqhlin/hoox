...
# B. Create the mesh index. CLI default dimensions are 768.
#    Telegram and gateway RAG embed with @cf/baai/bge-base-en-v1.5 (768-d).
hoox infra vectorize create my-rag-index --dimensions 768 --metric cosine
```
...
- [**Database Migrations & SQL**](/docs/enduser/guides/database-ops) — Run queries, manage drizzle schemas, and restore backups.
- [**Take-to-Production Deployments**](/docs/enduser/guides/deploy-workers) — Deploy your compiled workers and bind V8 isolates globally.
