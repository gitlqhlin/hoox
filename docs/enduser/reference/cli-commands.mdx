...
hoox setup       # Mesh keys (incl. WALLET_EXECUTE), Solana seed if missing, D1 schema, secrets, dashboard
...
- [**Configuration Dictionary**](/docs/enduser/getting-started/configuration) — Environment variables and CONFIG_KV keys.
