...
git clone --recursive https://github.com/<YOUR_USERNAME>/hoox.git
cd hoox
...
| Resource              | Link                                                                                                             |
| --------------------- | ---------------------------------------------------------------------------------------------------------------- |
| Bug Tracker           | [GitHub Issues](https://github.com/hoox-sh/hoox/issues)                                                          |
| Documentation Home    | [docs/enduser/home.md](docs/enduser/home.md)                                                                     |
| DevOps Manual         | [docs/devops/home.md](docs/devops/home.md)                                                                       |
| Enduser Full Docs PDF | [/hoox/Enduser-Full-Documentation.pdf](https://github.com/hoox-sh/hoox/blob/main/Enduser-Full-Documentation.pdf) |
| Latest Release        | [Releases Page](https://github.com/hoox-sh/hoox/releases)                                                        |
