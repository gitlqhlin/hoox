...
- See [architecture.mdx](/docs/enterprise/architecture) for overall topology.
- [observability-audit.mdx](/docs/enterprise/observability-audit) for per-tenant log isolation.
