...
| ------ | --------- | ------------------- |
| `dashboard` | `DashboardView` | `fetchWorkers`, `monitorStatus`, `checkFix`, `agentHealthCheck`, `pyneHealthCheck`, kill-switch |
...
Prefer a **dedicated management hostname** (e.g. `mgmt.example.com`) separate from TradingView `/webhook` ingress — see [Zero Trust](/docs/devops/deployment/zero-trust).
...
- **[Setup & Operations](/docs/devops/setup-and-operations)**  
- **[Architecture overview](/docs/devops/architecture/overview)**  
- **[End-user TUI guide](/docs/enduser/guides/tui)**  
